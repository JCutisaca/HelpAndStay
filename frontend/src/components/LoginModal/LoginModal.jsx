...
export default function LoginModal() {
    ...
    const handleSignInWithProvider = async () => await signIn("google", { redirect: false });

    return (
        <div className="absolute flex flex-col md:flex-row rounded-3xl border border-black shadow-2xl w-[40rem] h-[40rem] top-[5rem] z-[5] left-[50%] transform -translate-x-1/2">
            <div className="w-full h-full md:w-[50%] flex flex-col items-center justify-evenly bg-white rounded-s-3xl">
                ...
                <div className="w-[80%] flex flex-col items-center gap-4">
                    <button onClick={() => handleSignInWithProvider()} className="flex items-center justify-evenly text-nowrap text-lg font-monserrat font-semibold w-full text-black border-[#242424] border-solid border-2 rounded-xl p-1">
                        <svg
                            aria-hidden="true"
                            width="18" height="18"
                            viewBox="0 0 18 18">
                    ...
                    <button className="flex items-center justify-evenly text-nowrap text-lg font-monserrat font-semibold w-full text-white rounded-xl bg-[#1877F2] p-1">
                        <svg
                            aria-hidden="true"
                            width="18" height="18"
                            viewBox="0 0 18 18">
