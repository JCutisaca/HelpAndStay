    ...
    return (
        <nav className="flex items-center md:justify-around h-20 bg-white">
            ...
            <div className="hidden md:flex gap-4 w-[30%]">
                ...
                <button onClick={() => signIn()} className="text-xl font-monserrat font-semibold w-40 text-white text-nowrap bg-[#5196A6] rounded-xl hover:bg-[#F3A342] hover:text-white hover:border-none transition-all duration-500">Sign up</button>
            </div>
            {loginModal &&
                <div onClick={closeModal} className="fixed top-0 left-0 w-full h-full z-[3] bg-[#000000b3]">
                    <LoginModal />
                </div>
            }
