        ...
        <>
            <div className="hidden md:flex flex-col justify-center lg:gap-16 lg:flex-row mt-24">
                <div className="flex h-40 w-full lg:w-[40%] justify-between justify-between border-solid border-b-2 border-[#5196A6] lg:border-b-0">
                    <div className="w-[30%] flex justify-center items-center">
                        <Image className="w-24 lg:w-28 rounded-full border-solid border-4 border-[#5196A6] p-6" src={airplane}></Image>
                    </div>
                ...
                <div className="flex h-40 w-full lg:w-[40%] justify-between justify-between border-solid border-b-2 border-[#5196A6] lg:border-b-0">
                    <div className="w-[30%] flex justify-center items-center">
                        <Image className="w-24 lg:w-28 rounded-full border-solid border-4 border-[#72A689] p-6" src={handshake}></Image>
                    </div>
                    <div className="w-[70%] flex flex-col justify-center">
            ...
            <div className="hidden md:flex flex-col justify-center lg:gap-16 lg:flex-row lg:mt-24">
                <div className="flex h-40 w-full lg:w-[40%] justify-between border-solid border-b-2 border-[#5196A6] lg:border-b-0">
                    <div className="w-[30%] flex justify-center items-center">
                        <Image className="w-24 lg:w-28 rounded-full border-solid border-4 border-[#F3A342] p-6" src={home}></Image>
                    </div>
                    <div className="w-[70%] flex flex-col justify-center">
                ...
                <div className="flex h-40 w-full lg:w-[40%] justify-between border-solid border-b-2 border-[#5196A6] lg:border-b-0">
                    <div className="w-[30%] flex justify-center items-center">
                        <Image className="w-24 lg:w-28 rounded-full border-solid border-4 border-[#BF9E80] p-6" src={happy}></Image>
                    </div>
                    <div className="w-[70%] flex flex-col justify-center">
